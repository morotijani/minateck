...
?>
    ...
    <div class="position-relative py-210">
        <div class="background">
            <div class="background-image jarallax" data-jarallax data-speed="0.8">
                <img class="jarallax-img" loading="lazy" src="<?= PROOT; ?>assets/media/bg-6.jpg" alt="">
            </div>
    ...
    <div class="pt-120 pb-180 footerPrev">
        <div class="container">
            <div class="row gy-50">
                <div class="col-lg-4">
                    <!-- Item-->
                    <div class="d-flex" data-show="startbox">
                        <div class="flex-shrink-0">
                            <svg class="text-primary" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none">
                        ...
                        <div class="flex-grow-1 ms-15">
                            ...
                            <p class="m-0 mt-15">Email: hello@minateck.com <br>Phone: +233 207 112 82 85</p>
                        </div>
                    </div><!-- Item-->
                    <div class="d-flex mt-50" data-show="startbox" data-show-delay="100">
                        <div class="flex-shrink-0">
                            <svg class="text-primary" xmlns="http://www.w3.org/2000/svg" width="15" height="17" fill="none">
                        ...
                        <div class="flex-grow-1 ms-15">
                            ...
                            <p class="m-0 mt-15">2260 Lady Bug Drive, <br>New York, NY 10011</p>
                        </div>
                    </div>
                    <!-- Item-->
                        ...
                        <div class="row gy-40">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="personalData">I agree with the processing of personal data *</label>
                                </div>
                            </div>
    ...
    <div class="position-relative">
        <div class="half-section-block container position-absolute top-50 start-0 end-0" data-prev-id=".footerPrev" data-next-id=".footerNext">
            <div class="shape-parent">
                ...
                <!-- Map-->
                <div class="map-container bg-dark rounded-4 overflow-hidden" style="height: 506px;"><iframe src="https://maps.google.com/maps?q=manhatan&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed" allowfullscreen style="border: 0px;"></iframe></div>
            </div>
        </div>
    </div>
