...
<head>
    <meta charset="utf-8">
    <title><?= $pageTitle; ?> Minateck Engineering Services and Supplies</title>
    ...
    <link rel="stylesheet" href="<?= PROOT; ?>assets/css/swiper-bundle.css">
        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav me-100 nav-no-opacity">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle p-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">English<svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" fill="none">
            ...
            <ul class="nav navbar-nav nav-gap-xl nav-contacts nav-no-opacity">
                <li class="nav-item">
                    <a class="nav-link" href="tel:12023580309">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-primary" width="16" height="16" fill="none">
                        ...
                        </svg>+233 202-358-0309
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="mailto:help@minateck.com">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-primary" width="14" height="11" fill="none">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-primary" width="12" height="14" fill="none">
