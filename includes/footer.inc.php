        ...
        <div class="container">
            <div class="row gy-50">
                <div class="col-12 col-lg-3">
                    ...
                    <p class="font-size-13 text-muted m-0">&copy <?= date("Y"); ?> Alrights reserved. Minateck Engineering Service and Supplies.</p>
                </div>
                ...
                <div class="col-12 col-lg-7">
                    <div class="row gy-50">
                        ...
                        <div class="col-6 col-md-4">
                            ...
                            <ul class="nav flex-column text-white nav-opacity nav-gap-sm">
                                <li class="nav-item"><a class="nav-link" href="tel:12023580309">+233 202-358-0309</a></li>
                                <li class="nav-item"><a class="nav-link" href="tel:12023580408">+233 202-358-0408</a></li>
                                <li class="nav-item"><a class="nav-link" href="mailto:hello@startbox.com">hello@minateck.com</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <script src="assets/js/gist-embed.min.js"></script>
    <script src="assets/js/helpers.js"></script>
    <script src="assets/js/show-on-scroll.js"></script>
    <script src="assets/js/countdown.js"></script>
    <script src="assets/js/isotope.js"></script>
    <script src="assets/js/navbar.js"></script>
    <script src="assets/js/stretch-column.js"></script>
